...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = 'CloudTT'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'CloudTT'; /* short name, used when referring to the software */
